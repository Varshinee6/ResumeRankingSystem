...
GOOGLE_CLIENT_ID = "402677327666-3bbo83ol8rj10pmrkq4ekfo7s8ihgkel.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.2956fl5.mongodb.net/ResumeRanking'
...
nlp = spacy.load('assets/ResumeModel/ResumeModel/output/model-best')
